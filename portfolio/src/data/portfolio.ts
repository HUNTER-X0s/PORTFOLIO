...
export const personalInfo: PersonalInfo = {
  ...
  phone: '+91-7008973337',
  bio: 'B.Tech CSE student at GCE Kalahandi with 4 industry internships spanning Deep Learning, AI, Web Development, and Data Analytics. I build end-to-end intelligent systems — from computer vision pipelines and NLP models to full-stack web applications. Passionate about turning cutting-edge research into real, impactful products.',
  shortBio: 'B.Tech CSE @ GCE Kalahandi | AI/ML · Full-Stack · Data Science | 4 Internships',
  ...
  languages: [
    ...
    { language: 'Odia', level: 'Native' },
    { language: 'Bengali', level: 'Conversational' },
  ],
  hobbies: [
    'Competitive Chess',
    'Photography',
  ...
  fullstack: {
    ...
    whyHireMe: {
      ...
      points: [
        ...
        'Strong CS fundamentals from GCE Kalahandi (DSA, DBMS, Networking, OS)',
      ],
    },
    terminalLines: [
      '$ whoami',
  ...
  dl_engineer: {
    ...
    whyHireMe: {
      ...
      points: [
        ...
        'Strong theoretical foundation: Deep Learning coursework + hands-on architecture design',
      ],
    },
    terminalLines: [
  ...
  backend: {
    ...
    whyHireMe: {
      ...
      points: [
        ...
        'Strong algorithmic and systems-level engineering foundation from GCE Kalahandi',
      ],
    },
    terminalLines: [
