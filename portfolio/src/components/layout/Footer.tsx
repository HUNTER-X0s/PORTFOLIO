            ...
            <div className="flex items-center gap-3 pt-2">
              {personalInfo.social.slice(0, 4).map((social) => (
                <a
                  ...
                  className="w-10 h-10 rounded-full flex items-center justify-center bg-white/[0.03] border border-white/[0.08] text-text-secondary hover:text-cyan hover:border-cyan/30 hover:bg-cyan/[0.05] transition-all duration-300"
